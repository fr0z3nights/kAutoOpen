...
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
	...
	--	file:///C:\WoW\_retail_\Interface\AddOns\kAutoOpen\kAutoOpenEvent.lua
	--	file:///C:\WoW\_retail_\Interface\AddOns\kAutoOpen\kAutoOpenPortal.lua
...
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
--	@arch stand on all pads under valkyrie to skip them and unlock him	

			[229354] = true,	--		Algari Adventurer's Cache
			[228741] = true,	--		Lamplighter Supply Satchel
			[228361] = true,	--		Waxy Bundle
	...
	for bag = 0, 4 do
		for slot = 0, C_Container.GetContainerNumSlots(bag) do
			...
			if id and autoOpenItems[id] then
				DEFAULT_CHAT_FRAME:AddMessage("|cFFFFD700!AutoOpen|cFF9D9D9Ding " .. C_Container.GetContainerItemLink(bag, slot))
