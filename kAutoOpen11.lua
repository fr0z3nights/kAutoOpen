...
local autoOpenItems11 = {
			...
			-- [247821] = true,	--	Cache of K'areshi Treasures							Looted 250813 (duplicate)
			...
			-- [235054] = true,	--	Pristine Mysterious Cache							-- (duplicate)
...
kAutoOpen11:Register('BAG_UPDATE_DELAYED', function(bag)
	...
	for bag = 0, 4 do
		for slot = 1, C_Container.GetContainerNumSlots(bag) do
			...
			if id and autoOpenItems11[id] and canOpen then
