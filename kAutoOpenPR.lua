...
kAutoOpenPortal:Register('BAG_UPDATE_DELAYED', function(bag)
	...
	for bag = 0, 4 do
		for slot = 1, C_Container.GetContainerNumSlots(bag) do
			...
			if	GetMinimapZoneText() == "Wizard's Sanctum" and id and autoOpenItemsPR[id] and canOpen then
			...
			--	Horde Portal Room
			if	GetMinimapZoneText() == "Pathfinder's Den" and id and autoOpenItemsPR[id] and canOpen then
			...
			--	Dalaran Portal Room
			if	GetMinimapZoneText() == "Chamber of the Guardian" and id and autoOpenItemsPR[id] and canOpen then
